...
(function(){
    ...
    var ENDPOINT = "http://api.flickr.com:8000/services/rest/";
...
(function(){
    ...
    var CACHE_TTL    =  60000, //86400000, //one day in seconds
        CACHE_PREFIX = 'ti2';
    ...
    function getCached(mykey) {
        ...
        if(memoryCache[key]) {
            ...
            if(Date.now() - memoryCache[key].date > CACHE_TTL) {
    ...
    function fetchPhotos(query, page, callback) {
        ...
        if(cached) {
            ...
            flickr.makeRequest(
                ...
                {text:query, extras:'url_n,owner_name,height_n,width_n', per_page:5, page:page},
